...
public class ScheduleDTO {
    ...
    public ScheduleDTO(String id, String planeId, String sourceAirportId, String destinationAirportId,
			String departureTime, String arrivalTime, List<BookingDTO> bdto) {
		super();
		this.id = id;
